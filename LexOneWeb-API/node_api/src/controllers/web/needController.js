                ...
                if (appSettings.instantLocation.toString() == "true") {
                    if (category.locationType == "transport") {
                        if (!req.body.source_location || !req.body.source_lat || !req.body.source_lon || !req.body.dest_location || !req.body.dest_lat || !req.body.dest_lon ) {
                            ...
                            bookingDetails.sourceLat = parseFloat(req.body.source_lat);
                            bookingDetails.sourceLon = parseFloat(req.body.source_lon);
                            bookingDetails.destLocation = req.body.dest_location;
                            bookingDetails.destLat = parseFloat(req.body.dest_lat);
                            bookingDetails.destLon = parseFloat(req.body.dest_lon);
                            bookingDetails.loc = [parseFloat(req.body.source_lon), parseFloat(req.body.source_lat)];
                        }
                    }
        ...
        try {
            ...
            if (appSettings.instantLocation.toString() == "true") {
                ...
                let query = Booking.aggregate([
                    ...
                    {$unwind: '$service'},
                    { $limit : offset + parseInt(req.body.limit) },
                    { $skip : offset }
                ]);
