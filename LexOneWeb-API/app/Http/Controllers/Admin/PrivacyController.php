...
class PrivacyController extends Controller
{
	...
	{	
        if ($id == 'Tasker') {
            $help = Help::where('name',"Privacy Policy")->where('type', "tasker")->where('lang',$lang)->first();
            $edit = 'Tasker';
        }
        elseif ($id == 'User') {
            $help = Help::where('name',"Privacy Policy")->where('type', "user")->where('lang',$lang)->first();
            $edit = 'User';
        }
        ...
        return view('admin.privacy.create', ['help' => $help,'edit'=>$edit,'languages'=> $languages,'lang'=>$lang]);
	}
	...
	{	
        // ...................Store function...............
            ...
            if ($help->save()) {
                $notification = array(
                    'message' => __('messages.Privacy has been saved successfully'),
                    'alert-type' => 'success',
                );
            } else {
                $notification = array(
