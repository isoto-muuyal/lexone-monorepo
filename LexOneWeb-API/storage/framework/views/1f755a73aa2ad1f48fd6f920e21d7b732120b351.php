...
<form class="boxShadow p-t20 p-b20 p-l15 p-r10 bgWhite m-b20" action="<?php echo e(route('subcategory.store')); ?>" method="POST"  enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <h4 class="blueTxtClr p-t10 p-b10"><?php echo e(trans('messages.Add')); ?> <?php echo e(trans('messages.Subcategory')); ?></h4>
    <div class="form-group">
        <label><?php echo e(trans('messages.Name')); ?> </label> <span class="text-danger">*</span>  
        <input type="text" class="form-control" maxlength="30" name="category_name" placeholder=" <?php echo e(trans('messages.Subcategory')); ?> <?php echo e(trans('messages.Name')); ?>" value="<?php echo e(old('category_name')); ?>" required>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/subcategories/create.blade.php ENDPATH**/ ?>