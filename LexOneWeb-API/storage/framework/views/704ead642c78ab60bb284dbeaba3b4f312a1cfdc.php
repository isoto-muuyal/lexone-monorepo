<label><?php echo e(__('messages.Country')); ?></label><span class="text-danger">*</span>  
<div class="form-group">
    <div class="form-row">
        <div class="col">
            <select class="form-control target alphacode" id="alphacode" name="alphacode" required>
                <?php if($location): ?>
                    <option value="<?php echo e($location->alphaCode); ?> - <?php echo e($location->country); ?>" selected><?php echo e($location->country); ?></option>
                <?php else: ?>
                    <option value="">Select Country</option>
                    <option value="AF-Afghanistan">Afghanistan</option>
                    <option value="AL-Albania">Albania</option>
                    <option value="DZ-Algeria">Algeria</option>
                    <option value="AS-AmericanSamoa">American Samoa</option>
                    <option value="AD-Andorra">Andorra</option>
                    <option value="AO-Angola">Angola</option>
                    <option value="AI-Anguilla">Anguilla</option>
                    <option value="AQ-Antarctica">Antarctica</option>
                    <option value="AG-AntiguaandBarbuda">Antigua and Barbuda</option>
                    ...
                    <option value="BA-BosniaandHerzegovina">Bonaire, Sint Eustatius and Saba</option>
                    <option value="BW-Botswana">Bosnia and Herzegovina</option>
                    <option value="BV-BouvetIsland(Bouvetoya)">Botswana</option>
                    <option value="BR-Brazil">Bouvet Island</option>
                    <option value="IO-BritishIndianOceanTerritory(ChagosArchipelago)">Brazil</option>
                    <option value="VG-BritishVirginIslands">British Indian Ocean Territory</option>
                    <option value="BN-BruneiDarussalam">Brunei Darussalam</option>
                    <option value="BG-Bulgaria">Bulgaria</option>
                    <option value="BF-BurkinaFaso">Burkina Faso</option>
                    <option value="BI-Burundi">Burundi</option>
                    <option value="KH-Cambodia">Cambodia</option>
                    <option value="CM-Cameroon">Cameroon</option>
                    <option value="CA-Canada">Canada</option>
                    <option value="CV-CapeVerde">Cape Verde</option>
                    <option value="KY-CaymanIslands">Cayman Islands</option>
                    <option value="CF-CentralAfricanRepublic">Central African Republic</option>
                    <option value="TD-Chad">Chad</option>
                    <option value="CL-Chile">Chile</option>
                    <option value="CN-China">China</option>
                    <option value="CX-ChristmasIsland">Christmas Island</option>
                    <option value="CC-Cocos(Keeling)Islands">Cocos (Keeling) Islands</option>
                    <option value="CO-Colombia">Colombia</option>
                    <option value="KM-Comorosthe">Comoros</option>
                    <option value="CD-Congo">Congo</option>
                    <option value="CK-CookIslands">Cook Islands</option>
                    <option value="CR-CostaRica">Costa Rica</option>
                    <option value="HR-Croatia">Croatia</option>
                    <option value="CU-Cuba">Cuba</option>
                    <option value="CY-Cyprus">Cyprus</option>
                    <option value="CZ-CzechRepublic">Czech Republic</option>
                    <option value="DK-Denmark">Denmark</option>
                    <option value="DJ-Djibouti">Djibouti</option>
                    <option value="DM-Dominica">Dominica</option>
                    <option value="DO-DominicanRepublic">Dominican Republic</option>
                    <option value="EC-Ecuador">Ecuador</option>
                    <option value="EG-Egypt">Egypt</option>
                    <option value="SV-ElSalvador">El Salvador</option>
                    <option value="GQ-EquatorialGuinea">Equatorial Guinea</option>
                    ...
                    <option value="GW-GuineaBissau">Guinea-Bissau</option>
                    ...
                    <option value="TL-TimorLeste">Timor-Leste</option>
...
</div><?php /**PATH /var/www/html/resources/views/admin/location/alpha2code.blade.php ENDPATH**/ ?>