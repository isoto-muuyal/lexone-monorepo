<?php $__env->startSection('title', 'settlement | unpaid Detail'); ?>
    ...
    <div class="boxShadow p-t20 p-b20 p-l15 p-r10 bgWhite m-b20">
        ...
        <table id="example" class="table table-striped table-bordered mytable text-center">
            <tbody>
                ...
                <tr>
                    <th scope="col"><?php echo e(__('messages.Price')); ?></th>
                    <td class="fontSize15">
                ...
                <tr>
                    <th scope="col"><?php echo e(__('messages.Tasker Earnings')); ?></th>
                    <td class="fontSize15">
                        <b><?php echo e($currencySymbol); ?> <?php echo e($amount); ?></b>
                    </td>
                </tr>
                <tr>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/settlement/show.blade.php ENDPATH**/ ?>