<?php $__env->startSection('title', 'Currency Add'); ?>
<?php $__env->startSection('content'); ?>

<form class="boxShadow p-t20 p-b20 p-l15 p-r10 bgWhite m-b20" action="<?php echo e(route('currency.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <input type="hidden" id="ajax_url" url="<?php echo e(route('currency.ajaxcurrencyRate')); ?>" required/>
    <h4 class="blueTxtClr p-t10 p-b10"><?php echo e(trans('messages.Add')); ?> Currency</h4>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="m-t20">
        <button class="btn btn-primary align-text-top border-0 m-b10"><?php echo e(trans('messages.Add')); ?></button>
    </div>

</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/currency/create.blade.php ENDPATH**/ ?>