<?php if($edit == 'Tasker'): ?>
    <?php $__env->startSection('title', 'Terms | Tasker'); ?>
<?php else: ?>
    <?php $__env->startSection('title', 'Terms | User'); ?>
<?php endif; ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="boxShadow p-3 bgWhite m-b20">
        <div class="d-flex justify-content-between  flex-sm-row m-b25 services-new">
            <div>
                <h4 class="m-b25  blueTxtClr p-t10 p-b10"><?php echo e($edit == 'Tasker' ? "Tasker" : "User"); ?> <?php echo e(__('messages.Terms')); ?></h4>
            </div>  
            <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                <form action="<?php echo e(route('terms.create', ['id' => $edit,'lang'=>'en' ])); ?>" method="POST"  enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#status-selector").change(function(){
                ...
                if (edit == 'Tasker') {
                    window.location.href = "<?php echo e(route('terms.create', ['id' => 'Tasker',''])); ?>"+"/"+lang;
                }
                else{
                    window.location.href = "<?php echo e(route('terms.create', ['id' => 'User',''])); ?>"+"/"+lang;
                }
            });
        });
    </script>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/terms/create.blade.php ENDPATH**/ ?>