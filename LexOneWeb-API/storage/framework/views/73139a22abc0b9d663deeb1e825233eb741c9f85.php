...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between  flex-sm-row m-b25 services-new">
            <div>
            <h4 class="blueTxtClr p-t10 p-b10"><?php echo e(trans('messages.Subcategories')); ?></h4>
            </div>
            <div>
                <a href="<?php echo e(route('subcategory.add')); ?>">
                    <button class="btn btn-primary align-text-top border-0 m-b10">
                        <i class="fa fa-plus" title="<?php echo e(trans('messages.Add')); ?>"></i> 
                        <?php echo e(trans('messages.Add')); ?> <?php echo e(trans('messages.Subcategory')); ?>
        ...
        <div class="">
            <form method="GET" action="<?php echo e(route('subcategory.search')); ?>">
                        ...
                        <?php $__currentLoopData = $categoryrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="text-center">
                                ...
                                <td class="fontSize15 text-center">
                                    <a href="<?php echo e(route('subcategory.show', ['subcategoryId' => $category['_id']])); ?>" style="cursor: pointer;">
                                        <button class="btn btn-info align-text-top border-0"><i class="fa fa-eye" title="<?php echo e(trans('messages.Show')); ?>"></i></button>
                                    </a>
                                </td>
                                <td class="fontSize15 text-center">
                                    <a href="<?php echo e(route('subcategory.edit', ['categoryId' => $category['_id'], ])); ?>" style="cursor: pointer;">
                                        <button class="btn btn-info align-text-top border-0"><i class="fa fa-edit" title="<?php echo e(trans('messages.Edit')); ?>"></i></button>
                                    </a>
                                </td>
                                <td class="fontSize15 text-center">
                                    <?php if($category['status'] == 0): ?>
                                        <button class="btn btn-success align-text-top border-0"  data-toggle="modal" data-target="#exampleModalCenter-<?php echo e($category['_id']); ?>">
                                            <i class="fa fa-unlock" title="<?php echo e(trans('messages.Enable')); ?>"></i>
                                        </button>
                                    <?php else: ?>
                                        <button class="btn btn-danger align-text-top border-0" data-toggle="modal" data-target="#exampleModalCenter-<?php echo e($category['_id']); ?>">
    ...
    <!-- modal -->
    <?php $__currentLoopData = $categoryrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="exampleModalCenter-<?php echo e($category['_id']); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php if($category['status'] == 0): ?>
                             <?php echo e(__('messages.Do you want to enable this Subcategory?')); ?>

                        <?php else: ?>
                            <?php echo e(__('messages.Do you want to disable this Subcategory?')); ?> 
                        <?php endif; ?>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <?php if($category['status'] == 0): ?>
                            <a href="<?php echo e(route('subcategory.activestatus', ['categoryId' => $category['_id'], 'categoryStatus' =>1 ])); ?>" style="cursor: pointer;">
                                <button type="button" class="btn btn-success"><?php echo e(__('messages.Enable')); ?></button>
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('subcategory.activestatus', ['categoryId' => $category['_id'], 'categoryStatus' =>0 ])); ?>" style="cursor: pointer;">
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/subcategories/index.blade.php ENDPATH**/ ?>