...
<form class="boxShadow p-t20 p-b20 p-l15 p-r10 bgWhite m-b20" action="<?php echo e(route('category.update',['categoryId' => $categorydetails->_id])); ?>" method="POST"  enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <h4 class="blueTxtClr p-t10 p-b10"><?php echo e(trans('messages.Edit')); ?> <?php echo e(trans('messages.Category')); ?></h4>
    ...
    <div class="form-group">
        ...
        <select id="location-type" class="form-control" name="locationType" required>
            ...
            <option value="transport" <?php if(($categorydetails->locationType) == "transport"): ?> selected <?php endif; ?>><?php echo e(__('messages.Transport')); ?></option>
            <option value="remote" <?php if(($categorydetails->locationType) == "remote"): ?> selected <?php endif; ?>><?php echo e(__('messages.Remote')); ?></option>
            <option value="home" <?php if(($categorydetails->locationType) == "home"): ?> selected <?php endif; ?>><?php echo e(__('messages.Home')); ?></option>
        </select>
        ...
        <div class="m-b20 d-flex">
            <div class="m-r50">
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="professional" name="category_type" value="professional" <?php if($categorydetails->type === "professional"): ?> checked <?php endif; ?>>
                    <label class="custom-control-label" for="professional"><?php echo e(trans('messages.Professional')); ?></label>
                </div>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="marketplace" name="category_type" value="marketplace" <?php if($categorydetails->type === "marketplace"): ?> checked <?php endif; ?>>
                <label class="custom-control-label" for="marketplace"><?php echo e(trans('messages.Marketplace')); ?></label>
            </div>
        </div>
    </div>
    <div class="m-b20">
    ...
    <div class="form-group">
        <label><?php echo e(trans('messages.Featured')); ?></label>
        <div class="m-b20 d-flex">
            <div class="m-r50">
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="yes" name="category_feature" value="1" <?php if($categorydetails->featured == 1): ?> checked <?php endif; ?>>
                    <label class="custom-control-label" for="yes"><?php echo e(trans('messages.Yes')); ?></label>
                </div>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="no" name="category_feature" value="0" <?php if($categorydetails->featured == 0): ?> checked <?php endif; ?>>
    ...
    <div class="form-group" >
        ...
        <textarea id="editor1" name="description" maxlength="1200">
            <?php echo e($categorydetails->description); ?>
    ...
    <div class="form-group" >
        ...
        <textarea id="editor2" name="faq" maxlength="1200">
            <?php echo e($categorydetails->faq); ?>
    ...
    <div class="form-group" >
        ...
        <textarea id="editor3" name="about" maxlength="1200">
            <?php echo e($categorydetails->about); ?>
      ...
      <div >
        ...
        <div id="expand<?php echo e($language['code']); ?>">
          ...
          <textarea class="form-control" name="about<?php echo e($language['language']); ?>" id="count<?php echo e($language['language']); ?>" cols="30" rows="6" maxlength="1200" >
              <?php echo e($categorydetails->$langfaq); ?>
          ...
          <textarea class="form-control" name="faq<?php echo e($language['language']); ?>" id="about<?php echo e($language['language']); ?>" cols="30" rows="6" maxlength="1200" >
            <?php echo e($categorydetails->$langabout); ?>
          ...
          <textarea class="form-control" name="description<?php echo e($language['language']); ?>" id="Description<?php echo e($language['language']); ?>" cols="30" rows="6" maxlength="1200" >
            <?php echo e($categorydetails->$langdesc); ?>
...
<?php echo $__env->make('admin.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>