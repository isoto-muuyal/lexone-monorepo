...
class Booking extends Component {
    ...
    book_professional_service = () => {
        ...
        if(err === 0) {
            ...
            // LexOne: bookservice uses the placeholder office address. See lexOnePlaceholder.js.
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-6">
                                        <div className="col-12 px-0 mb-4">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                {/* <input type="text"  /> */}
                                                {/* LexOne: client no longer enters an address — block hidden, payload uses placeholder. */}
                                                {false &&
