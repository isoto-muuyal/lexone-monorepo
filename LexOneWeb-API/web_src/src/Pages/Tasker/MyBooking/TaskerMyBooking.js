...
class TakerMyBooking extends Component {
    ...
    get_ongoing_booking_details = () => {
        ...
        axios.post(`${process.env.REACT_APP_BASE_URL}/web/api/v1/tasker/bookings`,params,config)
        .then (res=>{ 
            ...
            <React.Fragment>
                ...
                <MetaDecorator title='| Tasker Jobs' description="IDemand Tasker Jobs"/>
                {
                    ...
                    <div className="container">
                        <div className="pt-5">
                            <h4 className="fM mb-3">{ i18next.t('My Tasks') }</h4>
                            <Tabs defaultActiveKey={ this.state.default_panel_active } className="bookingTab">
                                                                    ...
                                                                    <div className="detailsSection mt-3 mt-sm-0">
                                                                        ...
                                                                        {i.item_name}
                                                                            ...
                                                                            <div className="align-self-center font-sm mb-1"> </div>
                                                                                <div className="align-self-center font-sm mb-1">ID: <span>#{ i.reference_id && i.reference_id !== '' && i.reference_id.toUpperCase() }</span></div>
                                                        ...
                                                        <div className="col-sm-3 col-md-2">
                                                            <div className="mt-3 mt-lg-0 text-right d-flex flex-wrap align-items-center justify-content-between d-lg-block">
                                                                <div className="detailsSection text-left text-sm-right mb-lg-2">
                                                                    ...
                                                                    {
                                                                        i.status === 'started' && 
                                                                        <p className="mb-0 fM blueTxtClr">{ i18next.t('Ongoing') }</p>
                                                                    }
                                                                </div>
                                ...
                                <div className="d-grid place-items-center vh-50">
                                        <div>
                                            ...
                                            <div className="text-center font-xl py-3 fM">{ i18next.t('No Ongoing Task Found!') }</div>   
                                        </div>     
                                    </div>
                                }
                                {
                                ...
                                <TabPane tab={i18next.t("Completed")} key="2">
                                    ...
                                    <div className="d-grid place-items-center vh-50">
                                        <div>
                                            <img src={require("../../../assets/images/placeholder_logos(2).png")} alt=""
                                                className="placelogo-cls "  />
                                            <div className="text-center font-xl py-3 fM">{ i18next.t('No Completed Task Found!') }</div>   
                                        </div>     
                                    </div>
                                    }
                                    {
