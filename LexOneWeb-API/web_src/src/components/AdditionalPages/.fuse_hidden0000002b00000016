                    ...
                    <div className="pt-5">
                        ...
                        <div className="row px-3">
                            ...
                            <div className="col-sm-8 col-md-9 col-lg-9 col-xl-10 pl-0 pl-sm-3 pl-lg-0 pr-0">
                                ...
                                <div className="mb-2">
                                    <p className="title fM mb-2">You can delete your account from within TUDO. Deleting your account is an irreversible process, which we can't revert even if you perform it by accident.
To delete your account:</p>
                                ...
                                <p className="title fM mb-2">Deleting your account will:</p>
                                    <p className="content"> Delete your account from TUDO.</p>
                                    ...
                                    <p className="title fM mb-2">When you delete your account, your profile, jobs and task history will be permanently removed. If you'd just like to take a break, you can temporarily deactivate your account instead.</p>
                                    <p className="content"> Before deleting your account, you may want to login and download a copy of your information from . After your account has been deleted, you will not have access to the TUDO Data Download tool.</p>                                                              
                                    <p>Thanks.</p>                              
                                </div>
