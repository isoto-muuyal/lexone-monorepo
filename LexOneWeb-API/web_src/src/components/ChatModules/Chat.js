                                                ...
                                                <div className="detailsSection">
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="details overflow-hidden w-100">
                                                            <div className="detailOne text-truncate ">{ i18next.t('LexOne Team') }</div>
                                                            <div className="detailTwo text-truncate mb-1">{ i18next.t('Welcome to LexOne') } </div>
                                            ...
                                            <div className="cardOneStyle">
                                                <div className="detailsSection">
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="">
                                                            <div className="details">
                                                                <div className="detailOne text-truncate fM">{ i18next.t("LexOne team") }</div>
